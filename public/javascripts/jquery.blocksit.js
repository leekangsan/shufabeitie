(function($) {
    ...
    var setPosition = function(obj, index) {
        ...
        obj.css({
            'width': blockWidth - blocksOptions.offsetX,
            'left': pos[0] * colwidth + (blocksOptions.initX || 0),
            'top': pos[1] + (blocksOptions.initY || 0),
            'position': 'absolute'
        });
    ...
    $.fn.blocksDestroy = function() {
        $(this).css({height: 'auto'}).children(blocksOptions.blockElement).attr('style', '');
    }
